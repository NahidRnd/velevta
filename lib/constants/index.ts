export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || 'Velveta Store'
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_APP_DESCRIPTION || 'Velveta is a modern ecommerce platform built with Next.js'
